...
const Project = memo(() => {
  return (
    ...
    <div className="flex flex-col items-center justify-center left-0 w-screen">
        ...
        <div>
            <h5 className="bg-gradient-to-r from-orange-600 to-amber-300 bg-clip-text text-transparent text-center text-2xl max-sm:text-xl font-bold  mx-10 mt-10 mb-3 max-sm:mt-5"> Cryptofights Ascencion - 3D Turn-Based Online Game </h5>
                  
            <img src="./src/assets/image/cfsa1.png" alt="" className=" xl:w-300 md:w-110 max-sm:w-85 xl:h-150 md:h-80 max-sm:h-55 rounded-xl mx-auto" />
          ...
          <div className="flex flex-col-reverse md:grid md:grid-cols-2 md:gap-5 bg-stone-900">
              ...
              <div className="align-items-center justify-center mx-10 mt-5">
                ...
                <p className="bg-gradient-to-r from-amber-600 to-amber-300 bg-clip-text text-transparent text-start text-xl max-sm:text-sm font-bold">
              ...
              <div className="align-items-center justify-center mx-10 mt-5">
                  ...
                  <p className="bg-gradient-to-r from-amber-600 to-amber-300 bg-clip-text text-transparent text-start text-md max-sm:text-sm font-bold mt-5"> 
        ...
        <div>
            <h5 className="bg-gradient-to-r from-orange-600 to-amber-300 bg-clip-text text-transparent text-center text-2xl max-sm:text-xl font-bold  mx-10 mt-10 mb-3 max-sm:mt-5"> Rocky Rampage: Wreck ’em Up – 2D Action Game </h5>
                  
            <img src="./src/assets/image/rr1.png" alt="" className=" xl:w-300 md:w-110 max-sm:w-85 xl:h-150 md:h-80 max-sm:h-55 rounded-xl mx-auto" />
        ...
        <div>
            <h5 className="bg-gradient-to-r from-orange-600 to-amber-300 bg-clip-text text-transparent text-center text-2xl max-sm:text-xl font-bold  mx-10 mt-10 mb-3 max-sm:mt-5"> Palace of Enlightenment v1.0 – 2D Career Simulation Game </h5>
                  
            <img src="./src/assets/image/poe1.png" alt="" className=" xl:w-300 md:w-110 max-sm:w-85 xl:h-150 md:h-80 max-sm:h-55 rounded-xl mx-auto" />
        ...
        <div>
            <h5 className="bg-gradient-to-r from-orange-600 to-amber-300 bg-clip-text text-transparent text-center text-2xl max-sm:text-xl font-bold  mx-10 mt-10 mb-3 max-sm:mt-5"> Survival Planet – 3D Survival Game (PC, Steam) </h5>
                  
            <img src="./src/assets/image/si.jpg" alt="" className=" xl:w-300 md:w-110 max-sm:w-85 xl:h-150 md:h-80 max-sm:h-55 rounded-xl mx-auto" />
        ...
        <div>
            <h5 className="bg-gradient-to-r from-orange-600 to-amber-300 bg-clip-text text-transparent text-center text-2xl max-sm:text-xl font-bold  mx-10 mt-10 mb-3 max-sm:mt-5"> Fluffy Rush – Endless Runner Game for Kids (Android) </h5>
                  
            <img src="./src/assets/image/fluffy.png" alt="" className=" xl:w-300 md:w-110 max-sm:w-85 xl:h-150 md:h-80 max-sm:h-55 rounded-xl mx-auto" />
        ...
        <div>
            <h5 className="bg-gradient-to-r from-orange-600 to-amber-300 bg-clip-text text-transparent text-center text-2xl max-sm:text-xl font-bold  mx-10 mt-10 mb-3 max-sm:mt-5"> Mobile VR Laboratory – 3D Virtual Reality App (Android) </h5>
                  
            <img src="./src/assets/image/vrm.png" alt="" className=" xl:w-300 md:w-110 max-sm:w-85 xl:h-150 md:h-80 max-sm:h-55 rounded-xl mx-auto" />
        ...
        <div>
            <h5 className="bg-gradient-to-r from-orange-600 to-amber-300 bg-clip-text text-transparent text-center text-2xl max-sm:text-xl font-bold  mx-10 mt-10 mb-3 max-sm:mt-5"> Peace Hunter – Augmented Reality (AR) Educational Game (Android) </h5>
                  
            <img src="./src/assets/image/pch.png" alt="" className=" xl:w-80 md:w-70 max-sm:w-65 xl:h-150 md:h-80 max-sm:h-75 rounded-xl mx-auto" />
         ...
         <div>
            <h5 className="bg-gradient-to-r from-orange-600 to-amber-300 bg-clip-text text-transparent text-center text-2xl max-sm:text-xl font-bold  mx-10 mt-10 mb-3 max-sm:mt-5"> Nano Milenial Force – Educational Action Game (Android) </h5>
                  
            <img src="./src/assets/image/nano.png" alt="" className=" xl:w-300 md:w-110 max-sm:w-85 xl:h-150 md:h-110 max-sm:h-75 rounded-xl mx-auto" />
         ...
         <div>
            <h5 className="bg-gradient-to-r from-orange-600 to-amber-300 bg-clip-text text-transparent text-center text-2xl max-sm:text-xl font-bold  mx-10 mt-10 mb-3 max-sm:mt-5"> Mandalika VR 2018 – Virtual Reality Tourism App (Android) </h5>
                  
            <img src="./src/assets/image/mandalika2018.jpg" alt="" className=" xl:w-300 md:w-110 max-sm:w-85 xl:h-150 md:h-80 max-sm:h-55 rounded-xl mx-auto" />
         ...
         <div>
            <h5 className="bg-gradient-to-r from-orange-600 to-amber-300 bg-clip-text text-transparent text-center text-2xl max-sm:text-xl font-bold  mx-10 mt-10 mb-3 max-sm:mt-5"> Rabbit Rush – Casual Endless Runner Game (Android) </h5>
                  
            <img src="./src/assets/image/rabbit.jpg" alt="" className=" xl:w-300 md:w-110 max-sm:w-85 xl:h-150 md:h-80 max-sm:h-55 rounded-xl mx-auto" />
         ...
         <div>
            <h5 className="bg-gradient-to-r from-orange-600 to-amber-300 bg-clip-text text-transparent text-center text-2xl max-sm:text-xl font-bold  mx-10 mt-10 mb-3 max-sm:mt-5"> Green Building Simulator – Educational Simulation App (Android) </h5>
                  
            <img src="./src/assets/image/green.jpg" alt="" className=" xl:w-300 md:w-110 max-sm:w-85 xl:h-150 md:h-80 max-sm:h-55 rounded-xl mx-auto" />
